...
=== "Linux/macOS"
    ...
    $ docker build \
        -t registry.aisingapore.net/100e-bipo/fastapi-server:0.1.0 \
...
=== "Linux/macOS"
    ...
    $ docker run --rm -p 8080:8080 \
        ...
        registry.aisingapore.net/100e-bipo/fastapi-server:0.1.0
    ```
...
```bash
$ docker push registry.aisingapore.net/100e-bipo/fastapi-server:0.1.0
```
