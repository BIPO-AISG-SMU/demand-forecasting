...
=== "Linux/macOS"
    ...
    ```bash
    $ docker build \
        -t registry.aisingapore.net/100e-bipo/streamlit:0.1.0 \
...
=== "Linux/macOS"
    ...
    $ docker run --rm -p 8501:8501 \
        ...
        registry.aisingapore.net/100e-bipo/streamlit:0.1.0
    ```
...
```bash
$ docker push registry.aisingapore.net/100e-bipo/streamlit:0.1.0
```
...
=== "Linux/macOS"
    ...
    $ polyaxon run \
      ...
      -P DOCKER_IMAGE="registry.aisingapore.net/100e-bipo/streamlit:0.1.0" \
      -p bipo-<YOUR_NAME>
    ```
