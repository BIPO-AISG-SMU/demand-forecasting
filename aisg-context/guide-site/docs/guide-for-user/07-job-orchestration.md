...
=== "Linux/macOS"
    ...
    ```bash
    $ docker build \
        -t "registry.aisingapore.net/100e-bipo/data-prep:0.1.0" \
        -f docker/bipo-data-prep.Dockerfile \
        --platform linux/amd64 .
    $ docker push registry.aisingapore.net/100e-bipo/data-prep:0.1.0
    ```
...
=== "Linux/macOS"
    ...
    $ polyaxon run -f aisg-context/polyaxon/polyaxonfiles/process-data.yml \
        -P DOCKER_IMAGE="registry.aisingapore.net/100e-bipo/data-prep:0.1.0" \
...
=== "Linux/macOS"
    ...
    ```bash
    $ docker build \
        -t "registry.aisingapore.net/100e-bipo/model-train:0.1.0" \
        -f docker/bipo-model-training-gpu.Dockerfile \
        --platform linux/amd64 .
    $ docker push registry.aisingapore.net/100e-bipo/model-train:0.1.0
    ```
...
=== "Linux/macOS"
    ...
    $ polyaxon run -f aisg-context/polyaxon/polyaxonfiles/train-model-gpu.yml \
        -P DOCKER_IMAGE="registry.aisingapore.net/100e-bipo/model-train:0.1.0" \
